...
return base.constructor.extend({
	render:function(data){
		...
		/* Never observe podkop-ver-cell while also rewriting it: that creates a
		 * self-triggering MutationObserver loop and can peg the browser tab.
		 * A few bounded reassertions are enough to win over the generic async
		 * remote-version callback without introducing a live observer. */
