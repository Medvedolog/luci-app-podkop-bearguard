	...
	renderBody:function(data){
		...
		return E('div',{},[
			...
			E('div',{'class':'cbi-section pb-card','style':'max-width:820px;'},[
				...
				E('p',{'class':'pb-hint-90','style':'margin-top:.8em;'},_('OpenWrt Bearhole управляется в «Цепочке прокси» и может использовать WARP Rescue как один из системных резервных маршрутов.'))
			]),
